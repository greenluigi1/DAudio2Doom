...
char *D_FindIWAD(int mask, GameMission_t *mission)
{
    ...
    if (iwadparm)
    {
        DEH_printf("D_FindIWAD: iwadparm found");
        ...
        DEH_printf("D_FindIWAD: calling IdentifyIWADByName");
        *mission = IdentifyIWADByName(result, mask);
    }
    else
    {
        // Search through the list and look for an IWAD
        DEH_printf("Force setting WAD file");
        return "/appdata/DOOM.WAD";

        DEH_printf("-iwad not specified, trying a few iwad names\n");
